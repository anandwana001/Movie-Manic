...
import and.com.moviemanic.data.MovieDBHelper;
...
public class DatabaseTest {
    ...
    public void insert_single_record_test() throws Exception{
        ...
        testValues.put(MovieContract.MovieEntry.COLUMN_IMAGE, "test img");
        testValues.put(MovieContract.MovieEntry.COLUMN_OVERVIEW, "test_overview");
        testValues.put(MovieContract.MovieEntry.COLUMN_RATING, 99);
        testValues.put(MovieContract.MovieEntry.COLUMN_DATE, "test_11/3/17");
